...
<div class="row">
    ...
    <div class="col-md-8 col-lg-6">
        ...
        <div class="mb-3 row">
            <label class="col-3 col-form-label">老師編號</label>
            <div class="col-9">
                <label class="col-form-label"><?php echo $row["老師編號"]; ?></label>
            </div>
        </div>
        <div class="mb-3 row">
            <label class="col-3 col-form-label">指導班級</label>
            <div class="col-9">
                <label class="col-form-label"><?php echo $row["班級編號"]; ?></label>
            </div>
        </div>
        <div class="mb-3 row">
