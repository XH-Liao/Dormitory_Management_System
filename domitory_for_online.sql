...
('2023-01-06', 0, 0, 111, 1, 367, 'a1095503', NULL),
...
('2023-01-06', 0, 0, 111, 1, 373, 'a1095513', NULL),
...
('a1095502', 'A2', '', '', '男', '2000-01-02', '$2y$10$fWxQNOP7A6DGdIcv81D92OKcOme.c3N4AB7LdTFwKq8lVLOjBxR6m', 1, 'OE', 2),
('a1095503', 'A3', '', '', '男', '2000-01-03', '$2y$10$K7cfHFucnqQd5c1kqg6g5.kt.w4WLT/0VGoNmlpBU1m9jvBKWMV/u', NULL, NULL, NULL),
('a1095504', 'A4', '', '', '男', '2000-01-04', '$2y$10$g72jungmjAvO9zvkcpSJRO3Gm5Im4s2nWxXL7jdgLnmEP6ggsTnli', NULL, NULL, NULL),
('a1095505', 'A5', '', '', '男', '2000-01-05', '$2y$10$.QG.nrsnGqnNukqPA2c3gux20Iflz6ReQgvj6Zb0S2ZmfMLSeNC1O', NULL, NULL, NULL),
('a1095506', 'A6', '', '', '男', '2000-01-06', '$2y$10$rT3ZTdSpsP4TuedeBvxYLeb5oLysezvX0USEfrS5vCAN14rwGK8Dm', NULL, NULL, NULL),
('a1095507', 'A7', '', '', '男', '2000-01-07', '$2y$10$KHvBv1CEcpwJk3YR.i7bIOKEkZO3Bh4PO7FHTwH2V.9/4UVh86P/S', NULL, NULL, NULL),
('a1095508', 'A8', '', '', '男', '2000-01-08', '$2y$10$9/PM1i0lgUVMa9Ble2CNNulOTNaKFdQpX6FFAY0xDIxddjWQW7xo2', NULL, NULL, NULL),
('a1095509', 'A9', '', '', '男', '2000-01-09', '$2y$10$wEbvoaosmotsazDtWoogteqt/ziaPGWyrPKDnGfl4wH0523.EEDdO', NULL, NULL, NULL),
('a1095510', 'A10', '', '', '男', '2000-01-10', '$2y$10$E9Vi8ZAlwwnGauSdJsEGiuz32KdYKDkIjGhjcnD8gJ0ennh2lJSte', NULL, NULL, NULL),
('a1095512', 'A12', '', '', '女', '2000-01-12', '$2y$10$2wAcolBMeesjmNACLGHaZ.iOgnk8oRCvd.7n4hGOEoGRE.sHMTxz2', 1, 'OF', 12),
('a1095513', 'A13', '', '', '女', '2000-01-13', '$2y$10$00.e9EAlxEEUHwqWz/um2eHmvRihtTD3cZuTU2t0meJ6SP4801rg2', NULL, NULL, NULL),
('a1095514', 'A14', '', '', '女', '2000-01-14', '$2y$10$VojuW.3Nset3BhrjMD7fROpdwkRMbEipSVfz0HIz0pLOeGdwRWojC', NULL, NULL, NULL),
('a1095515', 'A15', '', '', '女', '2000-01-15', '$2y$10$VKmlTsieVNJ6eCL03N2NCOO50Te7pOQWZM9FIugqI6D92X74GpVUa', NULL, NULL, NULL),
('a1095516', 'A16', '', '', '女', '2000-01-16', '$2y$10$p5Hom10KmfIaFJkfOSh2ku52smUfDe.7gKoR7PsnBvXFLoc1MtG0e', NULL, NULL, NULL),
('a1095517', 'A17', '', '', '女', '2000-01-17', '$2y$10$BORNbb8AiH8sSHtSU4ToTeq975RdvrBWu44tqRq9CH17xgqRtYVdS', NULL, NULL, NULL),
('a1095518', 'A18', '', '', '女', '2000-01-18', '$2y$10$9T1HMoFq7h.CFDOk8qFUG.rC6Cs7p5FLoQgSBZ.n1GHMdrItutXym', NULL, NULL, NULL),
('a1095519', 'A19', '', '', '女', '2000-01-19', '$2y$10$0ah1M8A.nkuqSJVB4M4mluSi4FKwFfuwDsBA1XUEd9wDVp21wzvA2', NULL, NULL, NULL),
('a1095520', 'A20', '', '', '女', '2000-01-20', '$2y$10$csZBw4bxOBl3/3BNASGaqOyRVIomghWCTclNTNVWrQtOPvsjSzAz.', NULL, NULL, NULL);
...
ALTER TABLE `入住申請`
  ...
  ADD CONSTRAINT `入住申請_ibfk_2` FOREIGN KEY (`Account`) REFERENCES `系統管理員` (`Account`) ON UPDATE CASCADE;

--
-- 資料表的限制式 `學生`
--
ALTER TABLE `學生`
  ADD CONSTRAINT `學生_ibfk_1` FOREIGN KEY (`房間號碼`,`宿舍編號`) REFERENCES `宿舍房間` (`房間號碼`, `宿舍編號`) ON DELETE SET NULL,
