    ...
    while ($row_stu = mysqli_fetch_assoc($result_stu)) {
        ...
        if ($current >= 4) {
            ...
            if (!$row_room = mysqli_fetch_assoc($result_room)) {
                $_SESSION['msg_failed'] = "男宿申請人數大於目前的可容納量！";
                $_SESSION["msg_success"] = "男宿申請部分成功！(申請人數大於目前的可容納量)";
                break;
            }
        }
    }
