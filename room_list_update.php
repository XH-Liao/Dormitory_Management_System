...
<div class="row">
    ...
    <div class="col-md-8 col-lg-6">
        ...
        ?>
        <h1 style="color: #5275e0;">房間更新</h1>
        <form action="room_list_update_confirm.php" method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="房間號碼" class="form-control" required value="<?php echo $RoomID?>">
                </div>
            </div>
