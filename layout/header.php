...
//Check：密碼有修改
if ($title != "密碼修改" && isset($_SESSION["login_identity"]) && $_SESSION["changed_password"] != true) {
...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            if (id == "class_list" || id == "teacher_list" || id == "stu_list" || id == "admin_list" || id == "enroll") {
                $("#people").addClass("active");
            } else if (id == "moni_list" || id == "violate_list") {
    ...
    <link rel="icon" href="pic/house-door-fill.svg" type="image/x-icon" />
    <title>
        <?php echo $title; ?>
    </title>
    <!--bootstrap-->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse order-2 order-lg-1" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <?php
                    // 系統管理員的報修申請位在大樓&設備選單中，其餘身分皆於此顯示
                    ...
                    if (isset($_SESSION['login_identity'])) {
                        ...
                        if ($_SESSION["login_identity"] == "老師") {
                            print <<< EOT
                                    <li class="nav-item">
                                        <a class="nav-link" href="teacher_view_class" id='teacher_view_class'>
                        ...
                        if ($_SESSION["login_identity"] == "學生" || $_SESSION["login_identity"] == "舍監") {
                            print <<< EOT
                            <li class="nav-item">
                                <a class="nav-link" href="apply" id='apply'>
...
EOT;
                        ...
                        if ($_SESSION["login_identity"] == "舍監") {
                            print <<< EOT
                            <li class="nav-item">
                                <a class="nav-link" href="violate_list" id='monitor_violate'>
...
EOT;
                        ...
                        //系統管理員："分配房間"、"學生列表"、"管理員列表"、"舍監管理"、"大樓管理"、更改個資(for admin)、"註冊"
                        if ($_SESSION["login_identity"] == "系統管理員") {
                            print <<< EOT
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" id="people">
                                ...
                                <ul class="dropdown-menu"> <!-- dropdown-menu-right -->
                                    <li>
                                        <a class="dropdown-item" href="class_list" id='class_list'>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="teacher_list" id='teacher_list'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
...
EOT;
                            if ($_SESSION["login_account"] == "admin") {
                                print <<< EOT
                                        <li class="nav-item">
                                            <a class="dropdown-item" href="admin_list">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
...
EOT;
                            ...
                            print <<< EOT
                                    <li class="nav-item">
                                        <a class="dropdown-item" href="enroll" id='enroll'>
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" id="monitor_violate">
                                ...
                                <ul class="dropdown-menu"> <!-- dropdown-menu-right -->
                                    <li>
                                        <a class="dropdown-item" href="moni_list">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"  fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                                                <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
                                            </svg>
                                            舍監列表
                                    ...
                                    <li class="nav-item">
                                        <a class="dropdown-item" href="violate_list">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle-fill" viewBox="0 0 16 16">
                                                <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
                                            </svg>
                                            違規列表
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="assign_room_apply_list" id='assign_room_apply_list'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-clipboard-fill" viewBox="0 0 16 16">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" id="building">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-building-fill" viewBox="0 0 16 16">
                                ...
                                <ul class="dropdown-menu"> <!-- dropdown-menu-right -->
                                    <li>
                                        <a class="dropdown-item " href="domi_list" id='domi_list'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-building-fill-gear" viewBox="0 0 16 16">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="fix">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-tools" viewBox="0 0 16 16">
                                                <path d="M1 0 0 1l2.2 3.081a1 1 0 0 0 .815.419h.07a1 1 0 0 1 .708.293l2.675 2.675-2.617 2.654A3.003 3.003 0 0 0 0 13a3 3 0 1 0 5.878-.851l2.654-2.617.968.968-.305.914a1 1 0 0 0 .242 1.023l3.27 3.27a.997.997 0 0 0 1.414 0l1.586-1.586a.997.997 0 0 0 0-1.414l-3.27-3.27a1 1 0 0 0-1.023-.242L10.5 9.5l-.96-.96 2.68-2.643A3.005 3.005 0 0 0 16 3c0-.269-.035-.53-.102-.777l-2.14 2.141L12 4l-.364-1.757L13.777.102a3 3 0 0 0-3.675 3.68L7.462 6.46 4.793 3.793a1 1 0 0 1-.293-.707v-.071a1 1 0 0 0-.419-.814L1 0Zm9.646 10.646a.5.5 0 0 1 .708 0l2.914 2.915a.5.5 0 0 1-.707.707l-2.915-2.914a.5.5 0 0 1 0-.708ZM3 11l.471.242.529.026.287.445.445.287.026.529L5 13l-.242.471-.026.529-.445.287-.287.445-.529.026L3 15l-.471-.242L2 14.732l-.287-.445L1.268 14l-.026-.529L1 13l.242-.471.026-.529.445-.287.287-.445.529-.026L3 11Z"/>
                                            </svg>
                                            報修申請
                                    ...
                                    <li class="nav-item">
                                        <a class="dropdown-item" href="fix_list">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
                ...
                if (!isset($_SESSION['login_identity'])) {
                    print <<<EOT
                        <li class="nav-item">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                    ...
                    print <<<EOT
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end"> <!-- dropdown-menu-right -->
                                <li>
                                    <a href="alter_profile" class="dropdown-item">
...
EOT;
                    ...
                    print <<<EOT
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end"> <!-- dropdown-menu-right -->
                                <li>
                                    <a href="alter_admin_profile" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                                        </svg>
...
EOT;
                    ...
                    print <<<EOT
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end"> <!-- dropdown-menu-right -->
                                <li>
                                    <a href="alter_teacher_profile" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                                        </svg>
