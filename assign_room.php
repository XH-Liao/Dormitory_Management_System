...
<script>
    $(document).ready(function() {
        ...
        $('#firstSelect').change(function() {
            ...
            if (firstValue === '') {
                $('#secondSelect').html('<option value="">退宿</option>'); // 退宿
            } else {
                // 使用AJAX向PHP發送請求，獲取第二個下拉式選單的選項內容
                $.ajax({
                    url: "get_second_options.php",
                    method: "POST",
                    data: {
                        value: firstValue
                    },
        ...
        <div class="tab-content">
            ...
            <form action="assign_room_manual.php" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select id="firstSelect" class="form-select" name="宿舍編號" aria-label="Default select example">
                            ...
                            <option value="">退宿</option>
                            <?php
                            $SQL = "SELECT * FROM 宿舍大樓";
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select id="secondSelect" class="form-select" name="房間號碼">
