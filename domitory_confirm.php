...
$SQL="INSERT INTO 宿舍大樓 (大樓名稱,房間住宿費用,房間數,宿舍編號,性別) VALUES ('$DomitoryName','$Price','$RoomNum','$DomitoryNum','$Sex')";
$result=mysqli_query($link,$SQL);
if(!$result)
    {
...
for($count=1;$count<=$RoomNum;$count++)
{
    $SQL="INSERT INTO 宿舍房間(房間號碼,當前入住人數,宿舍編號) VALUES('$count','0','$DomitoryNum')";
    $result=mysqli_query($link,$SQL);
    if(!$result)
    {
        echo "<script type='text/javascript'>";
