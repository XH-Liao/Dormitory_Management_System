...
<div class="row">
    ...
    <div class="col-6">
        <butoon class="btn btn-primary" style="float: right;" data-bs-toggle="modal" data-bs-target="#announce_model">
            <i class="bi bi-megaphone-fill"></i>&nbsp; 新增公告
        </butoon>
    </div>
</div>
<!-- 新增公告 Modal -->
        ...
        <div class="modal-content">
            ...
            <form action="announce_insert_confirm.php" method="POST">
                    ...
                    <div class="mb-3 row" style="text-align: center;">
                        ...
                        <input type="submit" value="確認公告" class="btn btn-primary col-5">
                        </div>
                        <div class="col-1"></div>
                    </div>
                    </form>
...
<table class="table table-hover align-middle align-items-center ">
    ...
    <tbody>
        ...
        while($row = mysqli_fetch_assoc($result)){
            echo "<tr>";
            if(isset($_SESSION['login_identity']) && ($_SESSION['login_identity'] == "系統管理員" || $_SESSION['login_identity'] == "舍監")){
                echo "<td id='center'><a id='without_underline' href='announce_update?No=".$row['No']."'>&nbsp;<i class='bi bi-pencil-square'></i>&nbsp;</a>";
                echo "<a id='without_underline' href='announce_delete?No=".$row['No']."' onclick='return confirm(\"確認刪除此公告資料？\")'>&nbsp;<i class='bi bi-trash3'></i>&nbsp;</a></td>";
            }
            echo "<td>".$row['日期']."</td>";
