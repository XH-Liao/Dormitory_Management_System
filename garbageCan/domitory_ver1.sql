...
CREATE TABLE `學生` (
  ...
  `連絡電話` char(10) DEFAULT NULL,
  `性別` char(1) NOT NULL,
  `舍監編號` int(11) DEFAULT NULL,
  `密碼` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `生日` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `學生` (`學號`, `姓名`, `Email`, `連絡電話`, `性別`, `舍監編號`, `密碼`, `生日`) VALUES
('a123', 'A一', NULL, NULL, '男', NULL, 'Nuk2022-01-01', '2022-01-01');
...
INSERT INTO `系統管理員` (`Account`, `密碼`, `生日`, `姓名`) VALUES
('z123', 'Nuk2000-01-01', '2000-01-01', 'Z一');
...
CREATE TABLE `舍監_管理房號` (
  `管理房號` int(11) NOT NULL,
  `舍監編號` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `學生`
  ADD CONSTRAINT `學生_ibfk_1` FOREIGN KEY (`舍監編號`) REFERENCES `舍監` (`舍監編號`);
...
ALTER TABLE `宿舍房間`
  ...
  ADD CONSTRAINT `宿舍房間_ibfk_2` FOREIGN KEY (`學號`) REFERENCES `學生` (`學號`),
  ADD CONSTRAINT `宿舍房間_ibfk_3` FOREIGN KEY (`舍監編號`) REFERENCES `舍監` (`舍監編號`);
...
--
ALTER TABLE `管理`
  ADD CONSTRAINT `管理_ibfk_1` FOREIGN KEY (`No`) REFERENCES `系統消息` (`No`),
  ADD CONSTRAINT `管理_ibfk_2` FOREIGN KEY (`舍監編號`) REFERENCES `舍監` (`舍監編號`);
...
--
ALTER TABLE `舍監_管理房號`
  ADD CONSTRAINT `舍監_管理房號_ibfk_1` FOREIGN KEY (`舍監編號`) REFERENCES `舍監` (`舍監編號`);
