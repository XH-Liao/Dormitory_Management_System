...
if (!isset($_SESSION['login_identity']) || $_SESSION['login_identity'] != "系統管理員" || !isset($_GET['宿舍編號']) || !isset($_GET['房間號碼'])) {
...
<div class="row">
    ...
    <div class="col-md-8 col-lg-6">
        ...
        ?>
        <h1 style="color: #5275e0;">新增房間設備</h1>
        <form action="room_tool_confirm.php" method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="房間設備" class="form-control" required>
                </div>
            </div>
